...
export default function DispensaryDashboard({navigation}) {
  return (
    <ScrollView style={styles.container}>
      ...
      <View style={styles.chartContainer}>
        ...
        <Text style={styles.entriesCount}>Total Patient Entries: 1209 Entries</Text>
      ...
      <View style={styles.footerIcons}>
        <MaterialCommunityIcons name="hospital-building" size={50} color="gray" />
